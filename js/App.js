...
const brnEnsaladas = document.querySelector('.ensaladas');
const btnPostres = document.querySelector('.prostres');
...
{
  while (contenedor.firtsChild)
  {
    contenedor.removeChild(contenedor.firtsChild);
  }
}